...
test.describe("Import Various", () => {
  test("import V/A folders into library", async () => {
    ...
    await artistsList.getByText("Various Artists").click();

    const artistHeader = page.locator('[data-testid="ArtistPageHeader"]');
    await expect(artistHeader).toContainText("Various Artists");
