...
INSERT INTO "new_Release" ("artist_id", "createdAt", "discNumber", "discTitle", "entityType", "hash", "hideOnHomepage", "id", "mainReleaseId", "normalizedTitle", "path", "title", "type", "updatedAt", "year") SELECT "artist_id", "createdAt", "discNumber", "discTitle", "entityType", "hash", "hideOnHomepage", "id", "mainReleaseId", "normalizedTitle", "path", "title", "type", "updatedAt", "year" FROM "Release";
DROP TABLE "Release";
